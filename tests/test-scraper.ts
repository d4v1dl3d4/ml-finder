...
async function runTest() {
  ...
  for (const testProduct of testProducts) {
    ...
    try {
      ...
      console.error(`❌ Test failed for ${testProduct.titulo}:`, error);
    }
